<x-prose-layout>
    ...
    <form method="POST" action="{{ route('payment.store') }}">
        ...
        <div class="space-y-4">
            ...
            <p class="italic">Sikeres fizetés esetén a könyvet automatikusan elküldjük neked e-mailben. Amennyiben valami probléma merülne fel, a gergo@pandaegyetem.hu címen tudsz segítséget kérni.</p>
