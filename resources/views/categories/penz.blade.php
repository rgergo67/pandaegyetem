<x-sidebar-layout>
    ...
    <article class="mb-16 bg-white shadow-md overflow-hidden sm:rounded-lg">
        <a href="https://beosztom.hu/tanuld-meg-beosztani-a-penzed-diakkent" target="_blank">
        ...
        <div class="prose lg:prose-lg max-w-none p-6">
            <h2 class="pb-4"><a href="https://beosztom.hu/tanuld-meg-beosztani-a-penzed-diakkent" target="_blank">Tanuld meg beosztani a pénzed diákként</a></h2>
            <p>Diákként egyre több kiadásod lesz az évek során: buszjegy, koli díj, rezsi, kaja, tankönyvek, diákhitel. Ezek egy részére szüleid adnak pénzt, a maradékot diákmunkából kell majd kipótolnod. A <x-a href="https://beosztom.hu" target="_blank">Beosztom.hu</x-a> ennek a pénznek a beosztásában segítünk. </p>
        </div>
        <a class="block w-full bg-yellow-600 text-2xl text-white p-4" href="https://beosztom.hu/tanuld-meg-beosztani-a-penzed-diakkent" target="_blank">Olvasd el a teljes cikket...</a>
    </article>
