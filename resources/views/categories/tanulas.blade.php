<x-sidebar-layout>
    <x-seo title="Tanulás az egyetemen és a kollégiumban"
           description="Mutatunk rengeteg technikát, tippet és trükköt, melyet mi magunk is rendszeresen használunk, hogy hatékonyabban tudjunk tanulni." />
    ...
    <div class="text-left space-y-2 mb-8">
        ...
        <p>Mutatunk rengeteg technikát, tippet és trükköt, melyet mi magunk is rendszeresen használunk, hogy hatékonyabban tudjunk tanulni. Írtunk erről egy könyvet is <x-a href="{{ route('jobb-jegyek') }}"><strong>Jobb jegyek 10 lépésben: Hackeld meg az agyad!</strong></x-a> címmel!</p>
    </div>
