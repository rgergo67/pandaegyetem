<x-prose-layout>
    ...
    <p>1. A szolgáltatás igénybe vevője (a továbbiakban: Megrendelő) minden olyan, 16 év feletti természetes,
        ...
        Felek vagy Felek”.</p>
    <p> 2. Megrendelő a honlapon aktuálisan a Szolgáltató által kínált szolgáltatás igénybe vételével (a honlap
        használata során a regisztrációval, illetve a megrendeléssel) tudomásul veszi és elfogadja a jelen
        általános szerződési feltételekben foglalt valamennyi feltételt.</p>
    <h2>III. A szolgáltatás tárgya, megrendelés</h2>
    <h3>A Szolgáltatás tárgya:</h3>
    <p>A szolgáltatás tárgyát képezi valamennyi a honlapon aktuálisan található könyv, szolgáltatások illetve
    ...
    <h3>A megrendelés:</h3>
    <p>A megrendelés leadása regisztrációhoz kötött.
        ...
        megszüntetni.</p>
    <p>A termékek megrendelésekor Megrendelő az alábbi adatokat köteles a szolgáltatás teljesítéséhez
        rendelkezésre bocsátani:</p>
    <ul>
        <li>Személyes adatok: név (vezetéknév és keresztnév; e-mail cím;</li>
        <li>Számlázási adatok: Cégnév; számlázási cím (utca, házszám, város, irányítószám);</li>
    </ul>
    ...
    <h3>Felelősség:</h3>
    <p>Szolgáltató kijelenti, hogy nem vállal felelősséget,
        ...
        meghibásodásért, vagy az internet csatlakozás megszakadása miatt felmerült esetleges károkért.</p>
    <h2>V. Jogi nyilatkozat</h2>
    <p>A <em>Jobb jegyek 10 lépésbe: Hackeld meg az agyad</em> című könyv Ratting Gergely kizárólagos szellemi terméke, mely szerzői jogi védelem alatt áll.&nbsp;Ratting Gergely előzetes írásbeli engedélye nélkül a
        <em>Jobb jegyek 10 lépésbe: Hackeld meg az agyad</em> című könyv semmilyen formában nem használható fel (pl.: nyilvánosságra hozatal, terjesztés, másolás, többszörözés, stb.).
        ...
        Szolgáltatónak a jogsértésből eredő egyéb kárait, költségeit megtéríteni.</p>
    ...
    <p>A fizetéskor megadott adatok a számla kiállításához és a felhasználó azonosításához szükségesek. A személyes adatok megadása minden esetben önkéntes, az adatkezelés jogalapja a Felhasználó hozzájárulása, amelyet adatai megadásakor ad meg.</p>

    <p>Fizetéskor megadandó személyes adatok:</p>
    ...
    <p>Az Adatvédelmi törvény értelmében  Felhasználónak jogában áll rögzített adatairól tájékoztatást kapni. Jogában áll adatainak törlését, helyesbítését kérni, ezt bármikor írásban megteheti. A kifizetett szolgáltatási időszakról számla készül, melynek tárolása a hatályos jogszabályokban előírt módon és ideig történik. Felhasználó által megadott adatok valótlansága, hiányossága vagy pontatlansága illetve a jelen Nyilatkozatban foglalt feltételek  vagy a vonatkozó jogszabályok megsértése esetén, továbbá a rendszert érő bármilyen támadásból, jogosulatlan behatolásból származó adatbázis sérülésért, adatlopásért vagy egyéb kárért felelősséget nem vállalunk!</p>

    <h4>Tájékoztatás</h4>

    <p>Az Adatvédelmi Nyilatkozatban foglalt rendelkezésekre a magyar jog előírásai az irányadóak. Amennyiben vita esetén a felek békésen, peren kívül  megegyezni nem tudnak, a jogviták eldöntésére a Felek a Budapest Környéki Törvényszék illetékességét kötik ki. Az Üzemeltető jelen Nyilatkozatban foglalt rendelkezéseket – a vonatkozó jogszabályok keretein belül – bármikor módosíthatja, amely módosításokat a Felhasználó az oldal megnyitásával tudomásul veszi és magára nézve kötelezőnek ismeri el.</p>

    <h2>VI. Egyéb rendelkezések</h2>
    <p>A cookie, hírlevél és DM, továbbá az adatkezelés és feldolgozás vonatkozásában az Adatvédelmi
        ...
        történő – törlésére.
        Megrendelő a megrendelésével kapcsolatosan az info@pandaegyetem.hu elérhetőségen kérhet tájékoztatást, illetve
