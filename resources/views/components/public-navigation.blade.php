            ...
            <div class="flex col-span-1 w-full">
                ...
                <div class="flex-shrink-0 flex items-center w-full justify-between">
                    ...
                    <div class="hidden md:block md:ml-10 md:pr-4">
                        ...
                        <a href="{{ route('jobb-jegyek') }}" class="font-bold text-yellow-600 hover:text-yellow-700 h-16 inline-flex items-center px-4">Jobb jegyek</a>
                        <a href="https://beosztom.hu/tanuld-meg-beosztani-a-penzed-diakkent" class="font-bold text-green-600 hover:text-green-700 h-16 inline-flex items-center px-4">Spórolás</a>
                    </div>
                </div>
            </div>
